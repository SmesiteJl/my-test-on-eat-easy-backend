...
public class UserControllerIntegrationTest {
  ...
  void getAllUsersTest() {
    ResponseEntity<List<UserResponseDto>> response =
        testRestTemplate.exchange(
            "/api/v1/users", HttpMethod.GET, null, new ParameterizedTypeReference<>() {});
  ...
  void getUserByIdTest() {
    ...
    ResponseEntity<UserResponseDto> response =
        testRestTemplate.exchange(
            "/api/v1/users/" + createdUserId, HttpMethod.GET, null, UserResponseDto.class);
  ...
  void getUserByIdNotFoundTest() {
    ...
    ResponseEntity<String> response =
        testRestTemplate.exchange(
            "/api/v1/users/" + nonExistentId, HttpMethod.GET, null, String.class);
  ...
  void getUserByEmailTest() {
    ...
    ResponseEntity<UserWithHashPasswordResponseDto> response =
        testRestTemplate.exchange(
  ...
  void getUserByEmailNotFoundTest() {
    ...
    ResponseEntity<String> response =
        testRestTemplate.exchange(
            "/api/v1/users?email=" + nonExistentEmail, HttpMethod.GET, null, String.class);
  ...
  void deleteUserTest() {
    ...
    ResponseEntity<Void> deleteResponse =
        testRestTemplate.exchange(
            "/api/v1/users/" + userIdToDelete, HttpMethod.DELETE, null, Void.class);
  ...
  void deleteUserNotFoundTest() {
    ...
    ResponseEntity<String> response =
        testRestTemplate.exchange(
            "/api/v1/users/" + nonExistentId, HttpMethod.DELETE, null, String.class);
