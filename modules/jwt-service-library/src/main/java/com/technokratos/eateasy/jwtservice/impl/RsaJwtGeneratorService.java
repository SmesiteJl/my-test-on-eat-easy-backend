 ...
 *
 * <p>This service provides token generation capabilities with configurable expiration, issuer, and
 * support for custom claims. Uses RS256 algorithm for signing tokens.
 *
...
public class RsaJwtGeneratorService implements JwtGeneratorService {
  ...
  @Builder.Default private boolean supportsExtraClaims = true;

  /**
   * Generates JWT token with user details and additional claims.
   *
   * <p>Token includes standard claims:
   *
   * <ul>
   *   <li>Subject (username from UserDetails)
   *   <li>Issuer
   *   <li>Issued at
   *   <li>Expiration
   * </ul>
