 ...
 *
 * <p>Combines {@link JwtGeneratorService} and {@link JwtParserService} implementations to provide
 * complete JWT lifecycle management while maintaining separation of concerns. Acts as a facade that
 * coordinates token generation and validation workflows.
 */
...
public class CompositeJwtService implements JwtService {
   ...
   * {@inheritDoc}
   *
   * <p>Delegates token generation to configured {@link JwtGeneratorService}
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * <p>Delegates token validation to configured {@link JwtParserService}
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * <p>Delegates claims extraction to configured {@link JwtParserService}
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * <p>Delegates username extraction to configured {@link JwtParserService}
   */
  @Override
   ...
   */
  @Override
  public <T> @Nullable T extractClaim(String token, Function<Claims, T> claimExtractor)
