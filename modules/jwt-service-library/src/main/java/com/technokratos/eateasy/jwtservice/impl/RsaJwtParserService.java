 ...
 *
 * <p>Provides token validation and claims extraction functionality using RS256 signature
 * verification. Validates token structure, expiration, issuer claim, and required subject presence.
 *
...
public class RsaJwtParserService implements JwtParserService {
   ...
   *
   * <p>Performs following validations:
   *
   * <ul>
   *   <li>Token structure and format
   *   <li>Digital signature verification
   *   <li>Expiration time check
   *   <li>Issuer claim match
   *   <li>Subject presence
   * </ul>
   *
   ...
   *     <ul>
   *       <li>CredentialsExpiredException - expired token
   *       <li>InsufficientAuthenticationException - missing subject
   *       <li>BadCredentialsException - other validation failures
   *     </ul>
   */
  @Override
  public void validate(String token) throws AuthenticationException {
    ...
    try {
      ...
      log.debug(
          "Token validation failed: Claim validation failed. Got '{}'='{}'",
          e.getClaimName(),
          e.getClaimValue());
