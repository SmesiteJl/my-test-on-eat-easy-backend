 ...
 *
 * <p>Maps common Spring Security exceptions to appropriate HTTP status codes and client-friendly
 * messages while preventing sensitive information leakage.
 */
@Slf4j
public class ErrorResponseUsernamePasswordAuthenticationFailureHandler
   ...
   *
   * <ul>
   *   <li>BadCredentialsException → 401 Unauthorized
   *   <li>Account status exceptions → 403 Forbidden
   *   <li>AuthenticationServiceException → 500 Internal Server Error
   *   <li>Others → 400 Bad Request
   * </ul>
   */
   ...
   *
   * <ul>
   *   <li>Internal errors → Generic message
   *   <li>Bad credentials → "Invalid username or password"
   *   <li>Account status issues → Specific status description
   * </ul>
   */
