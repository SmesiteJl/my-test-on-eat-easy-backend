 ...
 *
 * <p>Coordinates token generation, validation, and invalidation by delegating to:
 *
 * <ul>
 *   <li>{@link RefreshTokenGeneratorService} for token creation
 *   <li>{@link RefreshTokenParserService} for validation and claims extraction
 *   <li>{@link RefreshTokenRepository} for token persistence operations
 * </ul>
 *
...
public class CompositeRefreshTokenService implements RefreshTokenService {
   ...
   * {@inheritDoc}
   *
   * <p>Invalidates token by removing it from persistence store after validation. Handles both valid
   * and pre-invalidated tokens.
   */
  @Override
