...
public class RequestCachingConfig {
  ...
  @Bean
  public FilterRegistrationBean<HttpServletRequestBodyCachingFilter>
      httpServletRequestBodyCachingFilterRegistrationBean() {
    FilterRegistrationBean<HttpServletRequestBodyCachingFilter> registrationBean =
