 ...
 *
 * <p>Contains settings for authentication endpoints, token parameters, and cryptographic key
 * configuration. Validates property values and provides sensible defaults.
 *
...
public class JwtProperties {
  ...
  @NotNull private MODE mode = MODE.OFF;

  /** Authentication endpoint paths */
  @NotEmpty private String loginUrl = "/auth/login";

  @NotEmpty private String refreshUrl = "auth/refresh";

  @NotEmpty private String logoutUrl = "/auth/logout";

  /** Issuer claim value for generated tokens */
  @NotEmpty private String issuer = "app";

  /** Token configuration parameters */
  @NotNull private TokenProperties tokens = new TokenProperties();

  /**
   * Authentication starter operation modes:
   *
   * <ul>
   *   <li>OFF - Authentication disabled
   *   <li>SERVER - Full validation and generation
   *   <li>CLIENT - Validation only
   * </ul>
   */
  public enum MODE {
    OFF,
  ...
  public static class TokenProperties {
    ...
    @NotNull private AccessTokenConfig access = new AccessTokenConfig();
  ...
  public static class AccessTokenConfig extends TokenConfig<AccessClaimsProperties> {
    ...
    @NotEmpty private String header = "Authorization";

    /** Authorization scheme prefix */
    @NotEmpty private String prefix = "Bearer ";
