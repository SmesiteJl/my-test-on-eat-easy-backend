 ...
 *
 * <p>Supports dual token retrieval strategies:
 *
 * <ul>
 ...
 */
public class TokenResponseRefreshTokenAuthenticationFilter
   ...
   *
   * <ol>
   *   <li>Extracting refresh token from cookie or request body
   *   <li>Retrieving client fingerprint from request body
   *   <li>Creating unauthenticated {@link RefreshAuthenticationToken}
   *   <li>Delegating to authentication manager
   * </ol>
   */
  @Override
  public Authentication attemptAuthentication(
    ...
    RefreshAuthenticationToken token =
        RefreshAuthenticationToken.unauthenticated(refreshToken, fingerprint);
  ...
  private String obtainRefreshTokenFromBody(HttpServletRequest request) {
    ...
    logger.trace(
        "Refresh token obtained from request body: %s".formatted(refreshRequest.refreshToken()));
  ...
  protected String obtainFingerprint(HttpServletRequest request) {
    ...
    logger.trace(
        "Fingerprint obtained from request body: %s".formatted(refreshRequest.fingerprint()));
