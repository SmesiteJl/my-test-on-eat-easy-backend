 ...
 *
 * <p>This is particularly useful in scenarios where the request payload needs to be inspected
 * multiple times (e.g., authentication processing, logging, or validation). The body is read and
 * cached on the first access of {@link #getInputStream()} or {@link #getReader()}, and subsequent
 * accesses use the cached data.
 *
