 ...
 *
 * <p>Implementations define security rules through the {@link HttpSecurity} API, allowing
 * customization of authentication, authorization, and other security aspects.
 *
 * @see HttpSecurity
 */
@FunctionalInterface
