...
public class RefreshConfig {
  ...
  public TokenResponseRefreshTokenAuthenticationFilter
      tokenResponseRefreshTokenAuthenticationFilter(
          @Qualifier("refreshSuccessHandler") AuthenticationSuccessHandler refreshSuccessHandler,
          @Qualifier("refreshFailureHandler") AuthenticationFailureHandler refreshFailureHandler) {
