 ...
 *
 * <p>Processes requests with header containing access token, authenticates it through Spring
 * Security's {@link AuthenticationManager}, and sets up ${@link SecurityContext} on successful
 * authentication.
 *
...
public class AccessTokenAuthenticationProcessingFilter extends OncePerRequestFilter {
   ...
   *
   * <ol>
   *   <li>Checks for valid header
   *   <li>Extracts token from header
   *   <li>Authenticates through ${@link AuthenticationManager}
   *   <li>Sets ${@link SecurityContext} on success
   *   <li>Handles authentication failures
   * </ol>
   */
  @Override
