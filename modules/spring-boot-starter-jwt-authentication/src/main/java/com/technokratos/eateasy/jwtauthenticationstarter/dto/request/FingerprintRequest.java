 ...
 *
 * <p>Used as foundation for authentication requests requiring client device identification.
 */
@SuperBuilder
@Jacksonized
...
public class FingerprintRequest {
   ...
   *
   * <p>Used to bind authentication session to specific client instance.
   */
