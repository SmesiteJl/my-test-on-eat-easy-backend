...
/**
 * Custom authentication filter that extracts credentials from JSON request body instead of form
 * parameters. Produces token responses on successful authentication.
 *
 * <p>Extends {@link UsernamePasswordAuthenticationFilter} to override credential extraction
 * behavior using {@link RequestMapper} for JSON deserialization.
 */
public class TokenResponseUsernamePasswordAuthenticationFilter
    extends UsernamePasswordAuthenticationFilter {

  private final RequestMapper requestMapper;

  @Builder
  public TokenResponseUsernamePasswordAuthenticationFilter(
