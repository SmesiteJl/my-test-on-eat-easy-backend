 ...
 *
 * <p>Configures cookies with:
 *
 * <ul>
 *   <li>HttpOnly flag
 *   <li>SameSite=Strict policy
 *   <li>Partitioned attribute
 *   <li>Duration-based expiration
 * </ul>
 */
@Slf4j
@Builder
...
public class SimpleRefreshTokenCookieWriter implements RefreshTokenCookieWriter {
  ...
  public void write(String refreshToken, HttpServletResponse response) {
    ...
    log.debug(
        "Refresh token cookie created: name={}, value={}, maxAge={}, path={}",
