...
public class SecurityConfig {
  ...
  public static class ServerSecurityConfig {
    ...
    private final TokenResponseUsernamePasswordAuthenticationFilter
        tokenResponseUsernamePasswordAuthenticationFilter;
    private final TokenResponseRefreshTokenAuthenticationFilter
        tokenResponseRefreshTokenAuthenticationFilter;
    ...
    public SecurityConfigurer securityConfigurer() {
      return http ->
          http.csrf(AbstractHttpConfigurer::disable)
              ...
              .addFilterBefore(
                  tokenResponseRefreshTokenAuthenticationFilter,
                  AccessTokenAuthenticationProcessingFilter.class)
