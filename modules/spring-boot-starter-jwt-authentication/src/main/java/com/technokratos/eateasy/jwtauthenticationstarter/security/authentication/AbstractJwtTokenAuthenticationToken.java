 ...
 *
 * <p>Manages token storage and authentication state transitions. Enforces proper authentication
 * flow by preventing manual authentication state changes.
 *
...
public abstract class AbstractJwtTokenAuthenticationToken extends AbstractAuthenticationToken {
   ...
   */
  protected AbstractJwtTokenAuthenticationToken(
