 ...
 *
 * <p>Processes a claim expected to be a collection of authority strings into {@link
 * GrantedAuthority} instances. Returns empty collection for non-collection claims or invalid
 * authority formats.
 */
@Slf4j
public class AuthoritiesClaimExtractor
    extends AbstractConfigurableClaimExtractor<Collection<? extends GrantedAuthority>> {
   ...
   *     <ul>
   *       <li>Claim is not a collection
   *       <li>Contains null/non-string values
   *     </ul>
   */
  @Override
