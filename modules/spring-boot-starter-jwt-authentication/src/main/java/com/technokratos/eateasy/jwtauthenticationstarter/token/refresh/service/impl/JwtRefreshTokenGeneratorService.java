 ...
 *
 * <p>Generates refresh tokens with security-enhanced features:
 *
 * <ul>
 *   <li>Persists token metadata with hashed client fingerprint
 *   <li>Includes token ID and user ID (if available) in JWT claims
 *   <li>Configurable token expiration duration
 * </ul>
 *
