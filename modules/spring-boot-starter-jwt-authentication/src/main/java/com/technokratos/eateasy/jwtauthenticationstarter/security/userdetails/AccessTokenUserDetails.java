 ...
 *
 * <p>Contains username and authorities without password storage. Suitable for token-based
...
public class AccessTokenUserDetails implements UserDetails {
   ...
   * {@inheritDoc}
   *
   * <p>Returns empty list if no authorities provided
   *
   * <p>
   */
  @Override
   ...
   */
  public static AccessTokenUserDetails of(
