 ...
 *
 * <p>Uses {@link ConcurrentHashMap} for storage with UUID keys. Suitable for:
 *
 * <ul>
 *   <li>Testing environments
 *   <li>Single-node development setups
 *   <li>Prototyping phases
 * </ul>
 *
 * @implNote This implementation is not suitable for production use due to lack of persistence and
 *     scalability.
