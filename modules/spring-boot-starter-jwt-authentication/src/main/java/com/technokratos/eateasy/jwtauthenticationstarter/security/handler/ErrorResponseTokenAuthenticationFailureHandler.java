 ...
 *
 * <p>Maps common token authentication exceptions to HTTP status codes and client messages with
 * context-specific token type naming (access/refresh).
 */
public class ErrorResponseTokenAuthenticationFailureHandler
  ...
  public ErrorResponseTokenAuthenticationFailureHandler(
      ObjectMapper objectMapper, String tokenName) {
    super(objectMapper);
