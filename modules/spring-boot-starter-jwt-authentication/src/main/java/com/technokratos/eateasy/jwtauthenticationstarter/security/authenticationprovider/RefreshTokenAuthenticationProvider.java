 ...
 *
 * <p>Handles refresh token authentication workflow:
 *
 * <ol>
 *   <li>Validates token signature and fingerprint match
 *   <li>Invalidates used refresh token after successful validation
 *   <li>Loads user details for security context creation
 *   <li>Generates new authenticated token with refreshed credentials
 * </ol>
 *
