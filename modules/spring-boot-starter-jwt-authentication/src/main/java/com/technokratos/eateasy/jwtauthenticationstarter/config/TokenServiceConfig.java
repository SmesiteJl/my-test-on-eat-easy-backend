...
public class TokenServiceConfig {
  ...
  @Bean
  public AccessTokenParserService accessTokenParserService(
      @Token(ACCESS) JwtParserService accessJwtParserService) {
  ...
  public class ServerOnlyTokenServiceConfig {
    ...
    public RefreshTokenGeneratorService refreshTokenGeneratorService() {
      return JwtRefreshTokenGeneratorService.builder()
          ...
          .refreshTokenIdClaim(
              jwtProperties.getTokens().getRefresh().getClaims().getRefreshTokenId())
    ...
    public RefreshTokenService refreshTokenService() {
      return new CompositeRefreshTokenService(
          refreshTokenGeneratorService(), refreshTokenParserService(), refreshTokenRepository);
    }
  }
}
