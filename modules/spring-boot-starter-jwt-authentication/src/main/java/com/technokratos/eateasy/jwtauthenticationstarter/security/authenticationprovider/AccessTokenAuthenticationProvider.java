 ...
 *
 * <p>Validates access tokens and constructs authenticated principal with:
 *
 * <ul>
 *   <li>Username from token subject
 *   <li>Authorities from token claims
 *   <li>Optional persistent user ID from claims
 * </ul>
 *
...
public class AccessTokenAuthenticationProvider implements AuthenticationProvider {
  ...
  private final ConfigurableClaimExtractor<? extends Collection<? extends GrantedAuthority>>
  ...
  private Collection<? extends GrantedAuthority> extractAuthorities(String jwt) {
    return Objects.requireNonNullElse(
        tokenParser.extractClaim(jwt, authoritiesExtractor), Collections.emptyList());
  }
