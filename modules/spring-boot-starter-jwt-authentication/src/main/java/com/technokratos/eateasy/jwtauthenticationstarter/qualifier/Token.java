...
/**
 * Qualifier annotation for distinguishing between different token types in dependency injection
 * contexts.
 *
 * <p>Used to identify specific token service implementations when multiple candidates exist.
 *
 * @see Qualifier
 */
@Qualifier
