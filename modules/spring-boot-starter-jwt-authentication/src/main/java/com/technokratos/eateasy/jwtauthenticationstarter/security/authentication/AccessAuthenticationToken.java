 ...
 *
 * <p>Represents both authenticated and unauthenticated states for access token authentication
 * workflow.
 */
public class AccessAuthenticationToken extends AbstractJwtTokenAuthenticationToken {
  ...
  private AccessAuthenticationToken(
   ...
   * @return authenticated token
   */
  public static AccessAuthenticationToken authenticated(
      String token, UserDetails userDetails, Collection<? extends GrantedAuthority> authorities) {
