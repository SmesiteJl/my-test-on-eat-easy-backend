...
class TokenResponseUsernamePasswordAuthenticationFilterTest {
  ...
  void setUp() {
    filter =
        TokenResponseUsernamePasswordAuthenticationFilter.builder()
    ...
    when(requestMapper.getObjectFromRequest(nonNullRequest, LoginRequest.class))
  ...
  void constructorShouldSetRequestMather() {
    Field field =
        ReflectionUtils.findField(
            TokenResponseUsernamePasswordAuthenticationFilter.class,
            "requiresAuthenticationRequestMatcher");
    ReflectionUtils.makeAccessible(field);
    AntPathRequestMatcher requestMatcher =
        (AntPathRequestMatcher) ReflectionUtils.getField(field, filter);
  ...
  void constructorShouldSetAuthenticationSuccessHandler() {
    Field field =
        ReflectionUtils.findField(
            TokenResponseUsernamePasswordAuthenticationFilter.class, "successHandler");
    ReflectionUtils.makeAccessible(field);
    AuthenticationSuccessHandler successHandler =
        (AuthenticationSuccessHandler) ReflectionUtils.getField(field, filter);
  ...
  void constructorShouldSetAuthenticationFailureHandler() {
    Field field =
        ReflectionUtils.findField(
            TokenResponseUsernamePasswordAuthenticationFilter.class, "failureHandler");
    ReflectionUtils.makeAccessible(field);
    AuthenticationFailureHandler failureHandler =
        (AuthenticationFailureHandler) ReflectionUtils.getField(field, filter);
  ...
  void constructorShouldSetAuthenticationManager() {
    Field field =
        ReflectionUtils.findField(
            TokenResponseUsernamePasswordAuthenticationFilter.class, "authenticationManager");
    ReflectionUtils.makeAccessible(field);
    AuthenticationManager authenticationManager =
        (AuthenticationManager) ReflectionUtils.getField(field, filter);
