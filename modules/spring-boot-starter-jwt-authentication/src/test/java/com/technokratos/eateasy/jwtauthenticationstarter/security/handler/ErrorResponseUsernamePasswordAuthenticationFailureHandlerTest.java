...
class ErrorResponseUsernamePasswordAuthenticationFailureHandlerTest {
  ...
  @InjectMocks private ErrorResponseUsernamePasswordAuthenticationFailureHandler handler;
  ...
  void onAuthenticationFailureShouldCorrectlyDetermineHttpStatusAndClientMessage(
      AuthenticationException exception, HttpStatus httpStatus, String message) throws Exception {

    ArgumentCaptor<ErrorResponse> errorResponseArgumentCaptor =
  ...
  private static Stream<Arguments> exceptionProvider() {
    return Stream.of(
        ...
        Arguments.of(new LockedException(""), HttpStatus.FORBIDDEN, "Account is locked"),
        Arguments.of(new DisabledException(""), HttpStatus.FORBIDDEN, "Account is disabled"),
        Arguments.of(
            new AuthenticationServiceException(""),
            HttpStatus.INTERNAL_SERVER_ERROR,
            "Internal authentication error"),
        Arguments.of(
            new CredentialsExpiredException(""), HttpStatus.FORBIDDEN, "Credentials expired"),
        Arguments.of(
            new InsufficientAuthenticationException(""),
            HttpStatus.BAD_REQUEST,
            "Authentication failed"),
        Arguments.of(new AccountExpiredException(""), HttpStatus.FORBIDDEN, "Account expired"));
  }
}
