...
class ErrorResponseTest {
  ...
  void buildFailsWhenMissingHttpStatus() {
    assertThrows(
        ...
        () -> ErrorResponse.builder().path(PATH).error(ERROR_MSG).build());
  }
  ...
  void buildFailsWhenMissingPath() {
    assertThrows(
        IllegalStateException.class,
        () -> ErrorResponse.builder().httpStatus(HttpStatus.BAD_REQUEST).error(ERROR_MSG).build());
  }
  ...
  void buildFailsWhenMissingError() {
    assertThrows(
        IllegalStateException.class,
        () -> ErrorResponse.builder().httpStatus(HttpStatus.BAD_REQUEST).path(PATH).build());
  }
