...
/**
 * Base class for all client error exceptions (HTTP 4xx status codes). Validates status codes belong
 * to 4xx range.
 *
...
public abstract class ClientErrorServiceException extends ServiceException {
  ...
  public ClientErrorServiceException(
      String message, HttpStatus httpStatus, Object details, Throwable cause) {
