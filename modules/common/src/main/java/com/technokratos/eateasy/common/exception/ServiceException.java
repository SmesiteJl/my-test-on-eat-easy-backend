...
/**
 * Base exception class for business layer operations. Intended to be extended by specific exception
 * types (e.g., {@code NotFoundException}) rather than thrown directly. Contains HTTP status
 * information and optional details about the error.
 *
 * @see HttpStatus
 */
public abstract class ServiceException extends RuntimeException {
  ...
  @Getter public final HttpStatus status;
  ...
  /**
   * Constructs a new service exception with message, HTTP status, and details. The cause is
  ...
  /**
   * Constructs a new service exception with message, HTTP status, and cause. Details are
   * initialized to {@code null}.
   *
   * @param message the detail message
   * @param httpStatus the HTTP status code
  ...
  /**
   * Constructs a new service exception with message and HTTP status. Details and cause are
   * initialized to {@code null}.
   *
   * @param message the detail message
   * @param httpStatus the HTTP status code
